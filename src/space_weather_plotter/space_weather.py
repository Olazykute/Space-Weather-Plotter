...
def prepare_dataframe(data, columns_mapping, nested_keys=None, timestamp_col=None):
    ...
    Args:
        data: The raw JSON data (list of dictionaries).
        columns_mapping: A dictionary mapping original JSON keys to desired DataFrame column names.
        timestamp_col: The name of the column to convert to datetime.
        nested_keys: A dictionary defining keys to extract from nested structures, if applicable.
